<template>
  ...
  >
    ...
    >
      ...
      <!-- <feather-icon v-if="item.icon != 'CircleIcon'" :icon="item.icon" /> -->
      <!-- <feather-icon v-if="item.children && item.children.length > 0" :icon="item.icon" /> -->
      <!-- <span v-else style="display: inline-block; width: 1.25rem; height: 1.25rem; margin-right: 1.1rem" /> -->

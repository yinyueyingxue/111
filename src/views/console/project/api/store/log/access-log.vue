  ...
  >
    ...
    >
      <template slot="table-row" slot-scope="props">
        ...
        <span v-else-if="props.column.field === 'executeTime'">
...
export default {
  ...
  data() {
    return {
      ...
      /*columns: [
        {key: 0, visible: true, label: "服务",field:'serviceId',sortable: false},
        {key: 1, visible: false, label: "traceId",field:'traceId',sortable: false},
        {key: 2, visible: true, label: "操作账号",field:'userId',sortable: false},
        {key: 3, visible: false, label: "操作账号名",field:'userName',sortable: false},
        {key: 4, visible: true, label: "IP",field:'clientIP',sortable: false},
        {key: 5, visible: false, label: "请求方法",field:'serviceId',sortable: false},
        {key: 6, visible: true, label: "请求URL",field:'requestMethod',sortable: false},
        {key: 7, visible: false, label: "异常信息",field:'exceptionMsg',sortable: false},
        {key: 8, visible: false, label: "响应状态码",field:'statusCode',sortable: false},
        {key: 9, visible: true, label: "执行时间",field:'executeTime',sortable: false},
        {key: 10, visible: true, label: "请求时间",field:'requestTime',sortable: false},
        {key: 11, visible: false, label: "日志类别",field:'category',sortable: false},
        {key: 12, visible: false, label: "操作前数据",field:'dataBefore',sortable: false},
        {key: 13, visible: false, label: "操作后数据",field:'dataAfter',sortable: false},
        {key: 14, visible: false, label: "安全性等级",field:'level',sortable: false},
        {key: 15, visible: false, label: "操作类型",field:'operationType',sortable: false},
        {key: 16, visible: true, label: "操作描述",field:'description',sortable: false},
        {key: 17, visible: false, label: "被操作账号",field:'targetId',sortable: false},
        {key: 18, visible: false, label: "被操作账号名",field:'targetName',sortable: false},
        {key: 19, visible: false, label: "预留字段1",field:'remark1',sortable: false},
        {key: 20, visible: false, label: "预留字段2",field:'remark2',sortable: false},
        {key: 21, visible: false, label: "预留字段3",field:'remark3',sortable: false},
        {key: 22, visible: false, label: "预留字段4",field:'remark4',sortable: false},
        {key: 23, visible: false, label: "预留字段5",field:'remark5',sortable: false},
      ],*/
      rows: [],
      searchTerm: '',
      form: {
  ...
  methods: {
    ...
    getLogList() {
      ...
      const _data = {
        curl: `${$themeConfig.app.logHttpUrl}/ipaas/store/log`,
        page: that.page,
